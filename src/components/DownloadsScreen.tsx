    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-black flex flex-col items-center justify-center px-4 pb-24">
        ...
        <div className="relative mb-6">
          <div className="absolute inset-0 bg-gradient-to-r from-[#FFD700] to-[#FFA500] blur-2xl opacity-20"></div>
          <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-3xl border border-[#FFD700]/20">
            <Download className="w-20 h-20 text-[#FFD700]" />
          </div>
        </div>
              ...
              <div className="flex-1 flex flex-col justify-between py-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-black px-4 py-2 rounded-lg font-black text-xs shadow-lg hover:shadow-[#FFD700]/50 transition-all"
                  >
