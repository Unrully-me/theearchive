...
import { ArrowLeft, Users, Film, Eye, Download, BarChart3, Activity, TrendingUp, Clock, Video, Home, Settings, Save, FileDown, DollarSign } from 'lucide-react';
...
export default function AdminPortal({ onAuthenticated, onNavigateToMovieAdmin }: AdminPortalProps = {}) {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'users' | 'reports' | 'ads' | 'settings'>('dashboard');
